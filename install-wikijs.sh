...
root@wikijs:/home/diegocosta# bash install-wikijs.sh
install-wikijs.sh: linha 6: $'\r': comando não encontrado
: opção inválidah: linha 7: set: -
set: uso: set [-abefhkmnptuvxBCEHPT] [-o option-name] [--] [-] [arg ...]
install-wikijs.sh: linha 8: $'\r': comando não encontrado
=== Instalador Wiki.js para Debian 13 ===

Aviso: Este script vai remover qualquer instalação existente do Wiki.js,
incluindo o banco de dados 'wikijs', o usuário 'wikijsuser' e a pasta /opt/wikijs.
Tenha certeza do que está fazendo antes de continuar.
': não é um identificador válidod: `CONFIRM
install-wikijs.sh: linha 15: $'\r': comando não encontrado
install-wikijs.sh: linha 167: erro de sintaxe: fim prematuro do arquivo
root@wikijs:/home/diegocosta# sed -i 's/\r$//' install-wikijs.sh
root@wikijs:/home/diegocosta# bash install-wikijs.sh
=== Instalador Wiki.js para Debian 13 ===
...
root@wikijs:/home/diegocosta# nano +15 install-wikijs.sh
root@wikijs:/home/diegocosta# cat install-wikijs.sh
#!/bin/bash
# Instalador automático do Wiki.js no Debian 13 (sem Docker)
# Autor: Diego Costa (@diegocostaroot) / Projeto Root (youtube.com/projetoroot)
# Versão: 1.0
